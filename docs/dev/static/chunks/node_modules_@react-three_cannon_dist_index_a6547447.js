...
"[project]/node_modules/@react-three/cannon/dist/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CannonDebugger(scene, world, _temp) {
    ...
    const _meshes = [];
    const _material = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MeshBasicMaterial"]({
    ...
    const _sphereGeometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SphereGeometry"](1);
    const _boxGeometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BoxGeometry"](1, 1, 1);
    const _planeGeometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PlaneGeometry"](10, 10, 10, 10); // Move the planeGeometry forward a little bit to prevent z-fighting
    _planeGeometry.translate(0, 0, 0.0001);
    function createConvexPolyhedronGeometry(shape) {
        const geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BufferGeometry"](); // Add vertices
        const positions = [];
        for(let i = 0; i < shape.vertices.length; i++){
            const vertex = shape.vertices[i];
            positions.push(vertex.x, vertex.y, vertex.z);
        }
        geometry.setAttribute('position', new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Float32BufferAttribute"](positions, 3)); // Add faces
        const indices = [];
    ...
    function createMesh(shape) {
        let mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mesh"]();
        const { SPHERE, BOX, PLANE, CYLINDER, CONVEXPOLYHEDRON, TRIMESH, HEIGHTFIELD } = Shape.types;
        switch(shape.type){
            case SPHERE:
                {
                    mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mesh"](_sphereGeometry, _material);
                    break;
                }
            case BOX:
                {
                    mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mesh"](_boxGeometry, _material);
                    break;
                }
            case PLANE:
                {
                    mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mesh"](_planeGeometry, _material);
                    break;
                }
            case CYLINDER:
                {
                    const geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CylinderGeometry"](shape.radiusTop, shape.radiusBottom, shape.height, shape.numSegments);
                    mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mesh"](geometry, _material);
    ...
    function typeMatch(mesh, shape) {
        ...
        const { geometry } = mesh;
        return geometry instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SphereGeometry"] && shape.type === Shape.types.SPHERE || geometry instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BoxGeometry"] && shape.type === Shape.types.BOX || geometry instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PlaneGeometry"] && shape.type === Shape.types.PLANE || geometry.id === shape.geometryId && shape.type === Shape.types.CYLINDER || geometry.id === shape.geometryId && shape.type === Shape.types.CONVEXPOLYHEDRON || geometry.id === shape.geometryId && shape.type === Shape.types.TRIMESH || geometry.id === shape.geometryId && shape.type === Shape.types.HEIGHTFIELD;
    }
...
const debugContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(null);
const useDebugContext = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(debugContext);
const physicsContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(null);
const usePhysicsContext = ()=>{
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(physicsContext);
...
const q$2 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Quaternion"]();
const s$1 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"](1, 1, 1);
const v$1 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"]();
const m$1 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix4"]();
const getMatrix = (o)=>{
    if (o instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InstancedMesh"]) {
...
function DebugProvider(_ref) {
    ...
    const [{ bodies, bodyMap }] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        bodies: [],
        bodyMap: {}
    });
    ...
    const [scene] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "DebugProvider.useState": ()=>new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Scene"]()
    }["DebugProvider.useState"]);
    const cannonDebuggerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(impl(scene, {
        bodies
    }, {
        color,
        scale
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])(debugContext.Provider, {
        value: api,
        children: [
...
const temp = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Object3D"]();
function useForwardedRef(ref) {
    const nullRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
...
const q$1 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Quaternion"]();
...
function useBody(type, fn, argsFn, fwdRef, deps) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"])({
        "useBody.useLayoutEffect": ()=>{
            if (!ref.current) {
                ...
                ref.current = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Object3D"]();
            }
            const object = ref.current;
            const currentWorker = worker;
            const objectCount = object instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InstancedMesh"] ? (object.instanceMatrix.setUsage(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DynamicDrawUsage"]), object.count) : 1;
            const uuid = object instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InstancedMesh"] ? new Array(objectCount).fill(0).map({
                "useBody.useLayoutEffect": (_, i)=>`${object.uuid}/${i}`
            }["useBody.useLayoutEffect"]) : [
                object.uuid
            ];
            const props = object instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InstancedMesh"] ? uuid.map({
                "useBody.useLayoutEffect": (id, i)=>{
                    const props = fn(i);
                    prepare(temp, props);
            ...
            }["useBody.useLayoutEffect"]) : uuid.map({
                "useBody.useLayoutEffect": (id, i)=>{
                    const props = fn(i);
    ...
    }["useBody.useLayoutEffect"], deps);
    const api = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useBody.useMemo[api]": ()=>{
            const makeAtomic = {
                "useBody.useMemo[api].makeAtomic": (type, index)=>{
                    const op = `set${capitalize(type)}`;
                    return {
                        set: ({
                            "useBody.useMemo[api].makeAtomic": (value)=>{
                                const uuid = getUUID(ref, index);
                                uuid && worker[op]({
                                    props: value,
                                    uuid
                        ...
                        })["useBody.useMemo[api].makeAtomic"],
                        subscribe: subscribe(ref, worker, subscriptions, type, index)
                    };
                }
            }["useBody.useMemo[api].makeAtomic"];
            const makeQuaternion = {
                "useBody.useMemo[api].makeQuaternion": (index)=>{
                    const type = 'quaternion';
                    return {
                        copy: ({
                            "useBody.useMemo[api].makeQuaternion": (_ref4)=>{
                                let { w, x, y, z } = _ref4;
                                const uuid = getUUID(ref, index);
                        ...
                        })["useBody.useMemo[api].makeQuaternion"],
                        set: ({
                            "useBody.useMemo[api].makeQuaternion": (x, y, z, w)=>{
                                const uuid = getUUID(ref, index);
                                uuid && worker.setQuaternion({
                                    props: [
                                        x,
            ...
            const makeRotation = {
                "useBody.useMemo[api].makeRotation": (index)=>{
                    return {
                        copy: ({
                            "useBody.useMemo[api].makeRotation": (_ref5)=>{
                                let { x, y, z } = _ref5;
                                const uuid = getUUID(ref, index);
                        ...
                        })["useBody.useMemo[api].makeRotation"],
                        set: ({
                            "useBody.useMemo[api].makeRotation": (x, y, z)=>{
                                const uuid = getUUID(ref, index);
                                uuid && worker.setRotation({
                                    props: [
                                        x,
                        ...
                        subscribe: ({
                            "useBody.useMemo[api].makeRotation": (callback)=>{
                                const id = incrementingId++;
                                const target = 'bodies';
                                const type = 'quaternion';
                                const uuid = getUUID(ref, index);
            ...
            const makeVec = {
                "useBody.useMemo[api].makeVec": (type, index)=>{
                    const op = `set${capitalize(type)}`;
                    return {
                        copy: ({
                            "useBody.useMemo[api].makeVec": (_ref6)=>{
                                let { x, y, z } = _ref6;
                                const uuid = getUUID(ref, index);
                                uuid && worker[op]({
                                    props: [
                        ...
                        })["useBody.useMemo[api].makeVec"],
                        set: ({
                            "useBody.useMemo[api].makeVec": (x, y, z)=>{
                                const uuid = getUUID(ref, index);
                                uuid && worker[op]({
                                    props: [
                                        x,
            ...
            function makeApi(index) {
                return {
                    ...
                    scaleOverride (scale) {
                        const uuid = getUUID(ref, index);
                        if (uuid) scaleOverrides[uuid] = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"](...scale);
                    },
                    sleep () {
                        const uuid = getUUID(ref, index);
                        uuid && worker.sleep({
            ...
            return {
                ...makeApi(undefined),
                at: ({
                    "useBody.useMemo[api]": (index)=>cache[index] || (cache[index] = makeApi(index))
                })["useBody.useMemo[api]"]
            };
        }
    }["useBody.useMemo[api]"], []);
...
function makeTriplet(v) {
    return v instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"] ? [
        v.x,
        v.y,
        v.z
    ] : v;
...
function usePlane(fn, fwdRef, deps) {
    return useBody('Plane', fn, {
        "usePlane.useBody": ()=>[]
    }["usePlane.useBody"], fwdRef, deps);
}
function useBox(fn, fwdRef, deps) {
    ...
    return useBody('Box', fn, {
        "useBox.useBody": function(args) {
            if (args === void 0) {
                args = defaultBoxArgs;
            }
            return args;
        }
    }["useBox.useBody"], fwdRef, deps);
}
function useCylinder(fn, fwdRef, deps) {
    return useBody('Cylinder', fn, {
        "useCylinder.useBody": function(args) {
            if (args === void 0) {
                args = [];
            }
            return args;
        }
    }["useCylinder.useBody"], fwdRef, deps);
}
function useHeightfield(fn, fwdRef, deps) {
    return useBody('Heightfield', fn, {
        "useHeightfield.useBody": (args)=>args
    }["useHeightfield.useBody"], fwdRef, deps);
}
function useParticle(fn, fwdRef, deps) {
    return useBody('Particle', fn, {
        "useParticle.useBody": ()=>[]
    }["useParticle.useBody"], fwdRef, deps);
}
function useSphere(fn, fwdRef, deps) {
    return useBody('Sphere', fn, {
        "useSphere.useBody": function(args) {
            if (args === void 0) {
                args = [
                    1
                ];
    ...
    }["useSphere.useBody"], fwdRef, deps);
}
function useTrimesh(fn, fwdRef, deps) {
    return useBody('Trimesh', fn, {
        "useTrimesh.useBody": (args)=>args
    }["useTrimesh.useBody"], fwdRef, deps);
}
function useConvexPolyhedron(fn, fwdRef, deps) {
    return useBody('ConvexPolyhedron', fn, {
        "useConvexPolyhedron.useBody": function(_temp) {
    ...
    }["useConvexPolyhedron.useBody"], fwdRef, deps);
}
function useCompoundBody(fn, fwdRef, deps) {
    return useBody('Compound', fn, {
        "useCompoundBody.useBody": (args)=>args
    }["useCompoundBody.useBody"], fwdRef, deps);
}
function useConstraint(type, bodyA, bodyB, optns, deps) {
    ...
    const uuid = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MathUtils"].generateUUID();
    const refA = useForwardedRef(bodyA);
    const refB = useForwardedRef(bodyB);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useConstraint.useEffect": ()=>{
            if (refA.current && refB.current) {
                ...
                return ({
                    "useConstraint.useEffect": ()=>worker.removeConstraint({
                            uuid
                        })
                })["useConstraint.useEffect"];
            }
        }
    }["useConstraint.useEffect"], deps);
    const api = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useConstraint.useMemo[api]": ()=>{
            const enableDisable = {
                disable: {
                    "useConstraint.useMemo[api]": ()=>worker.disableConstraint({
                            uuid
                        })
                }["useConstraint.useMemo[api]"],
                enable: {
                    "useConstraint.useMemo[api]": ()=>worker.enableConstraint({
                            uuid
                        })
                }["useConstraint.useMemo[api]"]
            };
            if (type === 'Hinge') {
                return {
                    ...enableDisable,
                    disableMotor: ({
                        "useConstraint.useMemo[api]": ()=>worker.disableConstraintMotor({
                                uuid
                            })
                    })["useConstraint.useMemo[api]"],
                    enableMotor: ({
                        "useConstraint.useMemo[api]": ()=>worker.enableConstraintMotor({
                                uuid
                            })
                    })["useConstraint.useMemo[api]"],
                    setMotorMaxForce: ({
                        "useConstraint.useMemo[api]": (value)=>worker.setConstraintMotorMaxForce({
                                props: value,
                                uuid
                            })
                    })["useConstraint.useMemo[api]"],
                    setMotorSpeed: ({
                        "useConstraint.useMemo[api]": (value)=>worker.setConstraintMotorSpeed({
                                props: value,
                                uuid
                            })
                    })["useConstraint.useMemo[api]"]
    ...
    }["useConstraint.useMemo[api]"], deps);
    return [
        refA,
        refB,
        api
...
function useSpring(bodyA, bodyB, optns, deps) {
    ...
    const { worker } = usePhysicsContext();
    const [uuid] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "useSpring.useState": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MathUtils"].generateUUID()
    }["useSpring.useState"]);
    const refA = useForwardedRef(bodyA);
    const refB = useForwardedRef(bodyB);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    }["useSpring.useEffect"], deps);
    const api = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useSpring.useMemo[api]": ()=>({
                setDamping: ({
                    "useSpring.useMemo[api]": (value)=>worker.setSpringDamping({
                            props: value,
                            uuid
                        })
                })["useSpring.useMemo[api]"],
                setRestLength: ({
                    "useSpring.useMemo[api]": (value)=>worker.setSpringRestLength({
                            props: value,
                            uuid
                        })
                })["useSpring.useMemo[api]"],
                setStiffness: ({
                    "useSpring.useMemo[api]": (value)=>worker.setSpringStiffness({
                            props: value,
                            uuid
                        })
                })["useSpring.useMemo[api]"]
            })
    }["useSpring.useMemo[api]"], deps);
    return [
        refA,
        refB,
        api
...
function useRay(mode, options, callback, deps) {
    ...
    const [uuid] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "useRay.useState": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MathUtils"].generateUUID()
    }["useRay.useState"]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useRay.useEffect": ()=>{
            events[uuid] = {
...
function useRaycastVehicle(fn, fwdRef, deps) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"])({
        "useRaycastVehicle.useLayoutEffect": ()=>{
            if (!ref.current) {
                // When the reference isn't used we create a stub
                // The body doesn't have a visual representation but can still be constrained
                // Yes, this type may be technically incorrect
            ...
            const wheelUUIDs = wheels.map({
                "useRaycastVehicle.useLayoutEffect.wheelUUIDs": (ref)=>getUUID(ref)
            }["useRaycastVehicle.useLayoutEffect.wheelUUIDs"]);
    ...
    }["useRaycastVehicle.useLayoutEffect"], deps);
    const api = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useRaycastVehicle.useMemo[api]": ()=>{
            return {
    ...
    }["useRaycastVehicle.useMemo[api]"], deps);
    return [
        ref,
        api
    ];
...
function useContactMaterial(materialA, materialB, options, deps) {
    ...
    const { worker } = usePhysicsContext();
    const [uuid] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "useContactMaterial.useState": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MathUtils"].generateUUID()
    }["useContactMaterial.useState"]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useContactMaterial.useEffect": ()=>{
    ...
    }["useContactMaterial.useEffect"], deps);
}
...
function PhysicsProvider(_ref) {
    ...
    const [{ bodies, events, refs, scaleOverrides, subscriptions, worker }] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "PhysicsProvider.useState": ()=>({
                bodies: {},
                events: {},
                refs: {},
                scaleOverrides: {},
    ...
    const loop = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PhysicsProvider.useCallback[loop]": (_, delta)=>{
            if (isPaused) return;
    ...
    }["PhysicsProvider.useCallback[loop]"], [
        isPaused,
        maxSubSteps,
        stepSize
    ]);
    ...
    const frameHandler = (_ref5)=>{
        ...
        for (const ref of Object.values(refs).filter(unique())){
            if (ref instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InstancedMesh"]) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$1eccaf1c$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__D__as__useFrame$3e$__["useFrame"])(loop);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(physicsContext.Provider, {
        value: value,
        children: children
    });
}
...
//# sourceMappingURL=node_modules_%40react-three_cannon_dist_index_a6547447.js.map